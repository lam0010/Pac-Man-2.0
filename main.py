...
# Background Music
BACKGROUND_MUSIC = pygame.mixer.music.load("sounds/BACKGROUND_MUSIC.wav")
pygame.mixer.music.play(-1)
pygame.mixer.music.set_volume(0.1)

# Sound Effects
PACMAN_CHOMP = pygame.mixer.Sound("sounds/PACMAN_CHOMP.wav")
PACMAN_EAT_GHOST = pygame.mixer.Sound("sounds/PACMAN_EAT_GHOST.wav")
PACMAN_EAT_POWERUP = pygame.mixer.Sound("sounds/PACMAN_EAT_POWERUP.wav")
PACMAN_HIT_GHOST = pygame.mixer.Sound("sounds/PACMAN_HIT_GHOST.wav")

# Screen Dimension
WIDTH = 900
HEIGHT = 950
pygame.display.set_caption("Pac-Man 2.0")
...
# Ghosts
blinky_img = pygame.transform.scale(pygame.image.load("images/ghost_images/red.png"), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load("images/ghost_images/pink.png"), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load("images/ghost_images/blue.png"), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load("images/ghost_images/orange.png"), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load("images/ghost_images/powerup.png"), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load("images/ghost_images/dead.png"), (45, 45))
...
# Other Essential Parts of The Game
# Right, Left, Up, Down
...
def check_collisions(scor, power, power_count, eaten_ghosts):
    ...
    if 0 < player_x < 870:
        if level[center_y // num1][center_x // num2] == 1:
            ...
            scor += 10
            PACMAN_CHOMP.play()
            PACMAN_CHOMP.set_volume(0.1)
        if level[center_y // num1][center_x // num2] == 2:
            level[center_y // num1][center_x // num2] = 0
            scor += 50
            PACMAN_EAT_POWERUP.play()
            PACMAN_EAT_POWERUP.set_volume(0.4)
            power = True
            power_count = 0
...
while run:
    ...
    if startup_counter < 270 and not game_over and not game_won:
        moving = False
        startup_counter += 1
    else:
        moving = True
    ...
    if not powerup:
        if (player_circle.colliderect(blinky.rect) and not blinky.dead) or \
            ...
            if lives > 0:
                lives -= 1
                PACMAN_HIT_GHOST.play()
                PACMAN_HIT_GHOST.set_volume(0.2)
                startup_counter = 0
                powerup = False
                power_counter = 0
                player_x = 450
    ...
    if powerup and player_circle.colliderect(blinky.rect) and not blinky.dead and not eaten_ghost[0]:
        ...
        PACMAN_EAT_GHOST.play()
        PACMAN_EAT_GHOST.set_volume(0.2)
